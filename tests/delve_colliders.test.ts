...
describe('delve module colliders', () => {
  ...
  it('module 0 right aisle is walkable; wall face is blocked', () => {
    ...
    const midZ = (DELVE_MODULE_LAYOUTS.reliquary_sunken_ossuary.zMin
      + DELVE_MODULE_LAYOUTS.reliquary_sunken_ossuary.zMax) / 2;
    const aisleX = 19;
  ...
  it('exit area of module 0 is bounded: back wall blocks entry from inside', () => {
    ...
    const res = resolvePosition(SEED, tryX, tryZ, 0.5, modules);
