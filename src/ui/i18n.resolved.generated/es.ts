...
export const es: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "lockCursorOnRotate": "Bloquear cursor al girar",
      "keybindHelpLockCursorOnRotate": "Mantiene el cursor del ratón dentro de la ventana mientras arrastras para girar la cámara, de modo que no pueda alcanzar el borde de la pantalla ni moverse a otro monitor. Desactívalo si prefieres un cursor libre.",
  ...
  "realm": {
    ...
    "medium": "Media",
    "low": "Baja",
    "popTipLow": "Población baja: menos de 15 jugadores en línea ahora. Hay mucho espacio; excelente para un nuevo comienzo.",
    "popTipMedium": "Población media: 15 a 39 jugadores en línea ahora. Un reino saludable y activo.",
    "popTipHigh": "Población alta: 40 a 79 jugadores en línea ahora. Muy concurrido, con muchos jugadores alrededor.",
    "popTipFull": "Población completa: 80 o más jugadores en línea ahora. Muy ocupado; puedes esperar en una cola de acceso.",
    "popTipOffline": "Desconectado: este reino es inalcanzable ahora y no se puede unir.",
