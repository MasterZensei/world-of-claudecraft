...
export const ru_RU: EnTranslations = {
  ...
  "guide": {
    ...
    "lore": {
      ...
      "elwynRole": "Страж Поляны Брайтвуда",
      "elwynBody": "Одинокая хранительница залитой солнцем рощи на севере Долины. Её дело, это попечение, а не резня: прореживать то, что расплодилось сверх меры, и даровать старейшему зверю рощи конец милосерднее, чем уготовили бы волки."
    },
    "dungeonsPage": {
  ...
  "entities": {
    ...
    "delves": {
      ...
      "delve_placeholder": {
        "name": "Неглубокая испытательная крипта",
        "enterText": "Вы спускаетесь в неглубокую испытательную крипту.",
        "leaveText": "Вы поднимаетесь обратно на поверхность."
      }
    }
  },
  "worldContent": {
