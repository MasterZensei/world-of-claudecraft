...
const delveEnTable = {
  ...
  "log.delveMechanismOpen": "A mechanism clicks open nearby. A passage opens to the north — find the exit portal ahead.",
  ...
  "log.delveBossChest": "The boss falls. A warded reliquary chest rises on the dais — pick its lock to claim your spoils.",
  "log.delveSurfaceStairs": "A stairway to the surface opens. Press F at the stairs to leave.",
  "log.delveModuleEnter": "{name} — {objective}",
  "log.delveTombstoneHint": "A tombstone passage opens to the north when the room is cleared.",
  "log.delveTombstoneOpen": "A sealed tombstone passage grinds open to the north. Walk into it to continue.",
  "log.delveTombstoneInto": "You pass through the tombstone into {name}.",
  "log.delveChestEmpty": "The chest is empty.",
  "log.delveLockYields": "The lock yields! {tier} spoils{detail}.",
  ...
  "error.delvePassageSealed": "The passage is sealed.",
  "error.delveMoveCloserPassage": "Move closer to the passage.",
  "error.delveMoveCloserChest": "Move closer to the chest.",
  "error.delveWayOutNotOpen": "The way out is not yet open.",
  "error.delveMoveCloserStairs": "Move closer to the stairs.",
  "error.delveLockpickAlreadyInProgress": "Someone is already working the lock.",
  "error.delveCannotPickThat": "You cannot pick that.",
  "error.delveLockpickChooseAnte": "Choose 1, 2, or 3 picks.",
  "error.delveLockpickNoAttempt": "No lock attempt in progress.",
  "error.delveLockpickNotYours": "That is not your lock.",
  "error.delveLockpickToolSlips": "That tool slips off this lock.",
} as const;
...
const DELVE_DICT_ES: Record<DelveSimMessageKey, string> = {
  ...
  "log.delveMechanismOpen": "Un mecanismo hace clic y se abre cerca. Un pasaje se abre al norte — encuentra el portal de salida.",
  ...
  "log.delveBossChest": "El jefe cae. Un cofre relicario protegido surge en el estrado — fuerza su cerradura para reclamar tu botín.",
  "log.delveSurfaceStairs": "Se abre una escalera hacia la superficie. Presiona F en las escaleras para salir.",
  "log.delveModuleEnter": "{name} — {objective}",
  "log.delveTombstoneHint": "Un pasaje de lápida se abre al norte cuando la sala sea despejada.",
  "log.delveTombstoneOpen": "Un pasaje de lápida sellado rechinando se abre al norte. Camina hacia él para continuar.",
  "log.delveTombstoneInto": "Pasas a través de la lápida hacia {name}.",
  "log.delveChestEmpty": "El cofre está vacío.",
  "log.delveLockYields": "¡La cerradura cede! Botín de {tier}{detail}.",
  ...
  "error.delvePassageSealed": "El pasaje está sellado.",
  "error.delveMoveCloserPassage": "Acércate más al pasaje.",
  "error.delveMoveCloserChest": "Acércate más al cofre.",
  "error.delveWayOutNotOpen": "La salida aún no está abierta.",
  "error.delveMoveCloserStairs": "Acércate más a las escaleras.",
  "error.delveLockpickAlreadyInProgress": "Alguien ya está forzando la cerradura.",
  "error.delveCannotPickThat": "No puedes forzar eso.",
  "error.delveLockpickChooseAnte": "Elige 1, 2 o 3 ganzúas.",
  "error.delveLockpickNoAttempt": "No hay ningún intento de ganzúa en progreso.",
  "error.delveLockpickNotYours": "Esa no es tu cerradura.",
  "error.delveLockpickToolSlips": "La herramienta resbala en esta cerradura.",
};
...
const DELVE_DICT_FR: Record<DelveSimMessageKey, string> = {
  ...
  "log.delveMechanismOpen": "Un mécanisme clique et s'ouvre à proximité. Un passage s'ouvre au nord — trouvez le portail de sortie.",
  ...
  "log.delveBossChest": "Le patron tombe. Un coffre reliquaire protégé s'élève sur l'estrade — crochetez sa serrure pour réclamer votre butin.",
  "log.delveSurfaceStairs": "Un escalier vers la surface s'ouvre. Appuyez sur F aux escaliers pour partir.",
  "log.delveModuleEnter": "{name} — {objective}",
  "log.delveTombstoneHint": "Un passage funéraire s'ouvre au nord quand la salle est dégagée.",
  "log.delveTombstoneOpen": "Un passage funéraire scellé grince et s'ouvre au nord. Entrez-y pour continuer.",
  "log.delveTombstoneInto": "Vous passez à travers la pierre tombale vers {name}.",
  "log.delveChestEmpty": "Le coffre est vide.",
  "log.delveLockYields": "La serrure cède ! Butin de {tier}{detail}.",
  ...
  "error.delvePassageSealed": "Le passage est scellé.",
  "error.delveMoveCloserPassage": "Rapprochez-vous du passage.",
  "error.delveMoveCloserChest": "Rapprochez-vous du coffre.",
  "error.delveWayOutNotOpen": "La sortie n'est pas encore ouverte.",
  "error.delveMoveCloserStairs": "Rapprochez-vous des escaliers.",
  "error.delveLockpickAlreadyInProgress": "Quelqu'un travaille déjà sur cette serrure.",
  "error.delveCannotPickThat": "Vous ne pouvez pas crocheter cela.",
  "error.delveLockpickChooseAnte": "Choisissez 1, 2 ou 3 crochets.",
  "error.delveLockpickNoAttempt": "Aucune tentative de crochetage en cours.",
  "error.delveLockpickNotYours": "Ce n'est pas votre serrure.",
  "error.delveLockpickToolSlips": "L'outil glisse sur cette serrure.",
};
...
const DELVE_DICT_IT: Record<DelveSimMessageKey, string> = {
  ...
  "log.delveMechanismOpen": "Un meccanismo scatta e si apre nelle vicinanze. Un passaggio si apre a nord — trova il portale d'uscita.",
  ...
  "log.delveBossChest": "Il boss cade. Un forziere reliquiario protetto emerge sul piedistallo — scassina la serratura per riscuotere il tuo bottino.",
  "log.delveSurfaceStairs": "Si apre una scala verso la superficie. Premi F alle scale per uscire.",
  "log.delveModuleEnter": "{name} — {objective}",
  "log.delveTombstoneHint": "Un passaggio funerario si apre a nord quando la stanza viene liberata.",
  "log.delveTombstoneOpen": "Un passaggio funerario sigillato scricchiola e si apre a nord. Cammina al suo interno per continuare.",
  "log.delveTombstoneInto": "Passi attraverso la lapide verso {name}.",
  "log.delveChestEmpty": "Il forziere è vuoto.",
  "log.delveLockYields": "La serratura cede! Bottino di {tier}{detail}.",
  ...
  "error.delvePassageSealed": "Il passaggio è sigillato.",
  "error.delveMoveCloserPassage": "Avvicinati al passaggio.",
  "error.delveMoveCloserChest": "Avvicinati al forziere.",
  "error.delveWayOutNotOpen": "L'uscita non è ancora aperta.",
  "error.delveMoveCloserStairs": "Avvicinati alle scale.",
  "error.delveLockpickAlreadyInProgress": "Qualcuno sta già lavorando sulla serratura.",
  "error.delveCannotPickThat": "Non puoi scassinare quello.",
  "error.delveLockpickChooseAnte": "Scegli 1, 2 o 3 grimaldelli.",
  "error.delveLockpickNoAttempt": "Nessun tentativo di scasso in corso.",
  "error.delveLockpickNotYours": "Quella non è la tua serratura.",
  "error.delveLockpickToolSlips": "L'attrezzo scivola su questa serratura.",
};
...
const DELVE_DICT_DE: Record<DelveSimMessageKey, string> = {
  ...
  "log.delveMechanismOpen": "In der Nähe klickt ein Mechanismus auf. Ein Durchgang öffnet sich im Norden — finde das Ausgangsportal.",
  ...
  "log.delveBossChest": "Der Boss fällt. Eine gesicherte Reliquiartruhe erhebt sich auf dem Podest — knacke ihr Schloss, um deine Beute zu beanspruchen.",
  "log.delveSurfaceStairs": "Eine Treppe zur Oberfläche öffnet sich. Drücke F an der Treppe, um zu gehen.",
  "log.delveModuleEnter": "{name} — {objective}",
  "log.delveTombstoneHint": "Ein Grabsteingang öffnet sich im Norden, wenn der Raum geleert ist.",
  "log.delveTombstoneOpen": "Ein versiegelter Grabsteingang knarrt im Norden auf. Geh hindurch, um fortzufahren.",
  "log.delveTombstoneInto": "Du gehst durch den Grabstein in {name}.",
  "log.delveChestEmpty": "Die Truhe ist leer.",
  "log.delveLockYields": "Das Schloss gibt nach! Beute: {tier}{detail}.",
  ...
  "error.delvePassageSealed": "Der Durchgang ist versiegelt.",
  "error.delveMoveCloserPassage": "Geh näher an den Durchgang heran.",
  "error.delveMoveCloserChest": "Geh näher an die Truhe heran.",
  "error.delveWayOutNotOpen": "Der Ausweg ist noch nicht offen.",
  "error.delveMoveCloserStairs": "Geh näher an die Treppe heran.",
  "error.delveLockpickAlreadyInProgress": "Jemand arbeitet bereits am Schloss.",
  "error.delveCannotPickThat": "Du kannst das nicht knacken.",
  "error.delveLockpickChooseAnte": "Wähle 1, 2 oder 3 Dietriche.",
  "error.delveLockpickNoAttempt": "Kein Schlossknack-Versuch läuft gerade.",
  "error.delveLockpickNotYours": "Das ist nicht dein Schloss.",
  "error.delveLockpickToolSlips": "Das Werkzeug gleitet von diesem Schloss ab.",
};
...
const DELVE_DICT_ZH_CN: Record<DelveSimMessageKey, string> = {
  ...
  "log.delveMechanismOpen": "附近的机关咔哒一声打开了。北方一条通道开启——找到出口传送门。",
  ...
  "log.delveBossChest": "首领倒下。台座上升起一口受保护的圣物箱——撬开它的锁以领取你的战利品。",
  "log.delveSurfaceStairs": "通往地面的阶梯开启。在阶梯处按 F 离开。",
  "log.delveModuleEnter": "{name} — {objective}",
  "log.delveTombstoneHint": "当房间清空后，北方将开启一条墓碑通道。",
  "log.delveTombstoneOpen": "一条封印的墓碑通道在北方嘎吱作响地打开。走入其中以继续前进。",
  "log.delveTombstoneInto": "你穿过墓碑进入了{name}。",
  "log.delveChestEmpty": "箱子是空的。",
  "log.delveLockYields": "锁被撬开了！{tier}级战利品{detail}。",
  ...
  "error.delvePassageSealed": "通道已封印。",
  "error.delveMoveCloserPassage": "靠近通道。",
  "error.delveMoveCloserChest": "靠近箱子。",
  "error.delveWayOutNotOpen": "出口尚未开启。",
  "error.delveMoveCloserStairs": "靠近阶梯。",
  "error.delveLockpickAlreadyInProgress": "已有人在撬这把锁。",
  "error.delveCannotPickThat": "你无法撬开它。",
  "error.delveLockpickChooseAnte": "选择 1、2 或 3 根撬锁工具。",
  "error.delveLockpickNoAttempt": "当前没有撬锁进行中。",
  "error.delveLockpickNotYours": "那不是你的锁。",
  "error.delveLockpickToolSlips": "工具在这把锁上滑脱了。",
};
...
const DELVE_DICT_ZH_TW: Record<DelveSimMessageKey, string> = {
  ...
  "log.delveComplete": "{name} 已完成。",
  "log.delveMechanismOpen": "附近的機關喀噠一聲打開了。北方一條通道開啟——找到出口傳送門。",
  ...
  "log.delveBossChest": "首領倒下。台座上升起一口受保護的聖物箱——撬開它的鎖以領取你的戰利品。",
  "log.delveSurfaceStairs": "通往地面的階梯開啟。在階梯處按 F 離開。",
  "log.delveModuleEnter": "{name} — {objective}",
  "log.delveTombstoneHint": "當房間清空後，北方將開啟一條墓碑通道。",
  "log.delveTombstoneOpen": "一條封印的墓碑通道在北方嘎吱作響地打開。走入其中以繼續前進。",
  "log.delveTombstoneInto": "你穿過墓碑進入了{name}。",
  "log.delveChestEmpty": "箱子是空的。",
  "log.delveLockYields": "鎖被撬開了！{tier}級戰利品{detail}。",
  "error.notInDelve": "你不在地下探索中。",
  ...
  "error.delveMoveCloserPassage": "靠近通道。",
  "error.delveMoveCloserChest": "靠近箱子。",
  "error.delveWayOutNotOpen": "出口尚未開啟。",
  "error.delveMoveCloserStairs": "靠近階梯。",
  "error.delveLockpickAlreadyInProgress": "已有人在撬這把鎖。",
  "error.delveCannotPickThat": "你無法撬開它。",
  "error.delveLockpickChooseAnte": "選擇 1、2 或 3 根撬鎖工具。",
  "error.delveLockpickNoAttempt": "目前沒有撬鎖進行中。",
  "error.delveLockpickNotYours": "那不是你的鎖。",
  "error.delveLockpickToolSlips": "工具在這把鎖上滑脫了。",
};
...
const DELVE_DICT_KO: Record<DelveSimMessageKey, string> = {
  ...
  "log.delveMechanismOpen": "근처에서 장치가 딸깍 열립니다. 북쪽에 통로가 열립니다 — 출구 포탈을 찾으세요.",
  ...
  "log.delveBossChest": "보스가 쓰러졌습니다. 단상에 보호된 성물함이 솟아오릅니다 — 자물쇠를 따서 전리품을 획득하세요.",
  "log.delveSurfaceStairs": "지상으로 가는 계단이 열립니다. 계단에서 F를 눌러 떠나세요.",
  "log.delveModuleEnter": "{name} — {objective}",
  "log.delveTombstoneHint": "방이 정리되면 북쪽에 묘석 통로가 열립니다.",
  "log.delveTombstoneOpen": "봉인된 묘석 통로가 북쪽에서 삐걱거리며 열립니다. 안으로 걸어 들어가 계속하세요.",
  "log.delveTombstoneInto": "묘석을 통해 {name}(으)로 들어갑니다.",
  "log.delveChestEmpty": "상자가 비어 있습니다.",
  "log.delveLockYields": "자물쇠가 열렸습니다! {tier} 등급 전리품{detail}.",
  ...
  "error.delvePassageSealed": "통로가 봉인되어 있습니다.",
  "error.delveMoveCloserPassage": "통로에 더 가까이 이동하세요.",
  "error.delveMoveCloserChest": "상자에 더 가까이 이동하세요.",
  "error.delveWayOutNotOpen": "출구가 아직 열리지 않았습니다.",
  "error.delveMoveCloserStairs": "계단에 더 가까이 이동하세요.",
  "error.delveLockpickAlreadyInProgress": "이미 누군가 자물쇠를 따고 있습니다.",
  "error.delveCannotPickThat": "저것은 딸 수 없습니다.",
  "error.delveLockpickChooseAnte": "1, 2 또는 3개의 따개를 선택하세요.",
  "error.delveLockpickNoAttempt": "진행 중인 자물쇠 따기 시도가 없습니다.",
  "error.delveLockpickNotYours": "저것은 당신의 자물쇠가 아닙니다.",
  "error.delveLockpickToolSlips": "도구가 이 자물쇠에서 미끄러집니다.",
};

const DELVE_DICT_JA: Record<DelveSimMessageKey, string> = {
  // Lockpicking minigame ships English-only for now (product decision); the
  // matcher needs the keys present so the sim text still resolves.
  "log.delveLockYields": "The lock yields! {tier} spoils{detail}.",
  "error.delveLockpickAlreadyInProgress": "Someone is already working the lock.",
  "error.delveCannotPickThat": "You cannot pick that.",
  "error.delveLockpickChooseAnte": "Choose 1, 2, or 3 picks.",
  ...
  "log.delveMechanismOpen": "近くで仕掛けがカチッと開きます。北に通路が開きました — 出口のポータルを探してください。",
  ...
  "log.delveBossChest": "ボスが倒れました。台座に聖遺物の箱が現れます — 開けて戦利品を手に入れましょう。",
  "log.delveSurfaceStairs": "地上への階段が開きました。階段でFキーを押して離脱してください。",
  "log.delveModuleEnter": "{name} — {objective}",
  "log.delveTombstoneHint": "部屋を制圧すると、北に墓石の通路が開きます。",
  "log.delveTombstoneOpen": "封印された墓石の通路が北でギシギシと開きます。中に入って進んでください。",
  "log.delveTombstoneInto": "墓石をくぐり、{name}に入ります。",
  "log.delveChestEmpty": "宝箱は空です。",
  ...
  "error.delvePassageSealed": "通路は封印されています。",
  "error.delveMoveCloserPassage": "通路に近づいてください。",
  "error.delveMoveCloserChest": "宝箱に近づいてください。",
  "error.delveWayOutNotOpen": "出口はまだ開いていません。",
  "error.delveMoveCloserStairs": "階段に近づいてください。",
};

const DELVE_DICT_PT: Record<DelveSimMessageKey, string> = {
  // Lockpicking minigame: English-only for now (see DELVE_DICT_JA note).
  "log.delveLockYields": "The lock yields! {tier} spoils{detail}.",
  "error.delveLockpickAlreadyInProgress": "Someone is already working the lock.",
  "error.delveCannotPickThat": "You cannot pick that.",
  "error.delveLockpickChooseAnte": "Choose 1, 2, or 3 picks.",
  ...
  "log.delveMechanismOpen": "Um mecanismo clica e se abre por perto. Uma passagem se abre ao norte — encontre o portal de saída.",
  ...
  "log.delveBossChest": "O chefe cai. Um baú relicário surge no altar — abra-o para reivindicar seus despojos.",
  "log.delveSurfaceStairs": "Uma escada para a superfície se abre. Pressione F na escada para sair.",
  "log.delveModuleEnter": "{name} — {objective}",
  "log.delveTombstoneHint": "Uma passagem funerária se abre ao norte quando a sala for limpa.",
  "log.delveTombstoneOpen": "Uma passagem funerária selada range e se abre ao norte. Caminhe até ela para continuar.",
  "log.delveTombstoneInto": "Você passa pela lápide para {name}.",
  "log.delveChestEmpty": "O baú está vazio.",
  ...
  "error.delvePassageSealed": "A passagem está selada.",
  "error.delveMoveCloserPassage": "Aproxime-se da passagem.",
  "error.delveMoveCloserChest": "Aproxime-se do baú.",
  "error.delveWayOutNotOpen": "A saída ainda não está aberta.",
  "error.delveMoveCloserStairs": "Aproxime-se da escada.",
};
...
const DELVE_DICT_RU: Record<DelveSimMessageKey, string> = {
  ...
  "log.delveMechanismOpen": "Рядом щёлкает и открывается механизм. На севере открывается проход — найдите выходной портал.",
  ...
  "log.delveBossChest": "Босс повержен. На постаменте появляется ларец с реликвией — откройте его, чтобы забрать добычу.",
  "log.delveSurfaceStairs": "Открылась лестница на поверхность. Нажмите F у лестницы, чтобы уйти.",
  "log.delveModuleEnter": "{name} — {objective}",
  "log.delveTombstoneHint": "Когда комната будет зачищена, на севере откроется надгробный проход.",
  "log.delveTombstoneOpen": "Запечатанный надгробный проход с грохотом открывается на севере. Войдите в него, чтобы продолжить.",
  "log.delveTombstoneInto": "Вы проходите через надгробие в {name}.",
  "log.delveChestEmpty": "Сундук пуст.",
  ...
  "error.delvePassageSealed": "Проход запечатан.",
  "error.delveMoveCloserPassage": "Подойдите ближе к проходу.",
  "error.delveMoveCloserChest": "Подойдите ближе к сундуку.",
  "error.delveWayOutNotOpen": "Выход ещё не открыт.",
  "error.delveMoveCloserStairs": "Подойдите ближе к лестнице.",
};
...
const RULES: Rule[] = [
  ...
  { re: /^You pass through the tombstone into (.+)\.$/, build: (m) => tSim('log.delveTombstoneInto', { name: m[1] }) },
  { re: /^The lock yields! (.+) spoils(.*)\.$/, build: (m) => tSim('log.delveLockYields', { tier: m[1], detail: m[2] }) },
  { re: /^(.+) — (.+)$/, build: (m) => tSim('log.delveModuleEnter', { name: m[1], objective: m[2] }) },
];
