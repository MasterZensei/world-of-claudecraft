  ...
  fr_FR: {
    hud: {
      ...
      options: {
        ...
        fpsReadout: "{fps} FPS",
        interfaceNote: "Ces options ne modifient que votre propre vue et sont enregistrées sur cet appareil.",
  ...
  de_DE: {
    hud: {
      ...
      options: {
        ...
        fpsReadout: "{fps} FPS",
        interfaceNote: "Diese Optionen ändern nur deine eigene Ansicht und werden auf diesem Gerät gespeichert.",
  ...
  pt_BR: {
    hud: {
      ...
      options: {
        ...
        fpsReadout: "{fps} FPS",
        interfaceNote: "Estas opções alteram apenas a sua própria visão e são salvas neste dispositivo.",
  ...
  ru_RU: {
    hud: {
      ...
      options: {
        ...
        fpsReadout: "{fps} FPS",
        interfaceNote: "Эти параметры меняют только ваш собственный вид и сохраняются на этом устройстве.",
  ...
  de_DE: {
    questUi: {
      ...
      dialog: {
        ...
        nythraxisDeathlessKingWarning: "Die drei Relikte erzählen dieselbe Geschichte: Aldren kämpfte, um seinen König zu verteidigen, Malric durchbrach die Grenze des Todes, und Voss versuchte aufzuhalten, was folgte. Das Siegel wird schwächer, und die verlassene Krypta ist der Weg nach unten.",
  ...
  ko_KR: {
    questUi: {
      ...
      dialog: {
        ...
        nythraxisDeathlessKingWarning: "세 유물은 같은 이야기를 전합니다. 알드렌은 왕을 지키려 싸웠고, 말릭은 죽음의 경계를 깨뜨렸으며, 보스는 그 뒤에 벌어진 일을 막으려 했습니다. 봉인이 약해지고 있으며, 버려진 묘실이 아래로 향하는 길입니다.",
...
const classAbilityNamesEn = {
  entities: {
    abilities: abilityTranslations([
      ...
      ["demoralizing_shout", "Demoralizing Shout", "Lets out a fearsome shout, reducing the attack power of all nearby enemies by 30 for 30 sec."],
      ...
      ["conjure_food", "Conjure Food", "Conjures 2 servings of bread, restoring health when eaten. Higher ranks conjure heartier fare."],
      ...
      ["pyroblast", "Pyroblast", "Hurls an immense fiery boulder that causes {damage} Fire damage plus additional damage over time."],
      ...
      ["garrote", "Garrote", "Garrote the enemy, causing damage now and bleeding it for {damage} over 18 sec. Must be stealthed. Awards 1 combo point."],
      ["cheap_shot", "Cheap Shot", "Strike the target, stunning it for 4 sec. Must be stealthed. Awards 2 combo points."],
      ["sap", "Sap", "Incapacitates the target for 8 sec. Must be stealthed and out of combat. Any damage breaks the effect."],
      ["crippling_poison", "Crippling Poison", "Strikes the target with a crippling poison, dealing {damage} Nature damage and slowing its movement speed by 50% for 12 sec."],
      ["expose_armor", "Expose Armor", "Finishing move that exposes the target, reducing its armor. More combo points spent build into a deeper cut."],
      ["rupture", "Rupture", "Finishing move that wounds the target, causing it to bleed for {damage} over 16 sec."],
      ["vanish", "Vanish", "Vanish from sight, entering Stealth even in combat. You move 30% slower while hidden. Lasts up to 10 sec."],
      ["instant_poison", "Instant Poison", "Coats your weapon for 30 min, causing each of your melee swings to deal 8 additional Nature damage."],
      ["deadly_poison", "Deadly Poison", "Coats your weapon for 30 min, causing each of your melee swings to deal 14 additional Nature damage."],
      ["blind", "Blind", "Blinds the target, causing it to wander disoriented for 8 sec. Any damage breaks the effect."],
      ...
      ["retribution_aura", "Retribution Aura", "Surrounds you with holy energy for 30 min, dealing 5 Holy damage to any enemy that strikes you in melee."],
      ...
      ["frostbrand_weapon", "Frostbrand Weapon", "Imbues your weapon with biting frost: each swing deals 8 additional damage for 5 min."],
      ...
      ["hibernate", "Hibernate", "Forces the target into a deep sleep for up to 8 sec. Any damage will awaken it."],
      ["dash", "Dash", "Sprint forward, increasing movement speed by 50% for 15 sec. Wolf Form only."],
      ["pounce", "Pounce", "A stealth opener that stuns the target for 2 sec. Awards 1 combo point. Wolf Form only."],
      ["insect_swarm", "Insect Swarm", "The enemy is swarmed by insects, taking {damage} Nature damage over 12 sec."],
      ["tigers_fury", "Tiger's Fury", "Increases attack power by 40 for 6 sec. Wolf Form only."],
      ["rip", "Rip", "Finishing move that causes Bleed damage over 12 sec. Consumes combo points. Wolf Form only."],
  ...
  es: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["demoralizing_shout", "Grito desmoralizador", "Lanza un grito aterrador y reduce el poder de ataque de todos los enemigos cercanos en 30 durante 30 s."],
        ...
        ["conjure_food", "Crear comida", "Crea 2 raciones de pan que restauran salud al comerlas. Los rangos superiores crean alimentos más nutritivos."],
        ...
        ["pyroblast", "Piroexplosión", "Lanza una inmensa roca ardiente que causa {damage} de daño de Fuego más daño adicional con el tiempo."],
        ...
        ["garrote", "Garrote", "Estrangula al enemigo con un garrote, infligiendo daño de inmediato y haciéndolo sangrar {damage} durante 18 s. Debes estar en sigilo. Otorga 1 punto de combo."],
        ["cheap_shot", "Ataque artero", "Golpea al objetivo, aturdiéndolo durante 4 s. Debes estar en sigilo. Otorga 2 puntos de combo."],
        ["sap", "Pasmar", "Incapacita al objetivo durante 8 s. Debes estar en sigilo y fuera de combate. Cualquier daño rompe el efecto."],
        ["crippling_poison", "Veneno tullidor", "Golpea al objetivo con un veneno tullidor, infligiendo {damage} de daño de Naturaleza y reduciendo su velocidad de movimiento un 50% durante 12 s."],
        ["expose_armor", "Exponer armadura", "Movimiento final que deja al descubierto al objetivo, reduciendo su armadura. Cuantos más puntos de combo se gasten, más profundo es el corte."],
        ["rupture", "Descoyuntar", "Movimiento final que hiere al objetivo, haciéndolo sangrar {damage} durante 16 s."],
        ["vanish", "Esfumarse", "Desaparece de la vista, entrando en Sigilo incluso en combate. Te mueves un 30% más lento mientras estás oculto. Dura hasta 10 s."],
        ["instant_poison", "Veneno instantáneo", "Recubre tu arma durante 30 min, haciendo que cada uno de tus golpes cuerpo a cuerpo inflija 8 de daño de Naturaleza adicional."],
        ["deadly_poison", "Veneno mortal", "Recubre tu arma durante 30 min, haciendo que cada uno de tus golpes cuerpo a cuerpo inflija 14 de daño de Naturaleza adicional."],
        ["blind", "Cegar", "Ciega al objetivo, haciéndolo deambular desorientado durante 8 s. Cualquier daño rompe el efecto."],
        ...
        ["retribution_aura", "Aura de retribución", "Te rodea de energía sagrada durante 30 min e inflige 5 de daño Sagrado a cualquier enemigo que te golpee cuerpo a cuerpo."],
        ...
        ["flametongue_weapon", "Arma Lengua de Fuego", "Imbuye tu arma con fuego elemental: cada golpe inflige 8 de daño de Fuego adicional durante 5 min."],
        ...
        ["frostbrand_weapon", "Arma de Escarcha", "Imbuye tu arma con escarcha mordiente: cada golpe inflige 8 de daño adicional durante 5 min."],
        ...
        ["travel_form", "Forma de viaje", "Adopta una veloz forma de viaje, aumentando la velocidad de movimiento un 40%. No se puede usar en combate."],
        ...
        ["hibernate", "Hibernar", "Sume al objetivo en un sueño profundo de hasta 8 s. Cualquier daño lo despertará."],
        ["dash", "Carrera", "Esprinta hacia delante, aumentando la velocidad de movimiento un 50% durante 15 s. Solo forma felina."],
        ["pounce", "Abalanzarse", "Apertura desde el sigilo que aturde al objetivo durante 2 s. Otorga 1 punto de combo. Solo forma felina."],
        ["insect_swarm", "Enjambre de insectos", "Un enjambre de insectos acosa al enemigo, causando {damage} de daño de Naturaleza durante 12 s."],
        ["tigers_fury", "Furia del tigre", "Aumenta el poder de ataque en 40 durante 6 s. Solo forma felina."],
        ["rip", "Desgarrar", "Remate que causa daño de sangrado durante 12 s. Consume puntos de combo. Solo forma felina."],
  ...
  fr_FR: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["demoralizing_shout", "Cri démoralisant", "Pousse un cri terrifiant qui réduit la puissance d'attaque de tous les ennemis proches de 30 pendant 30 s."],
        ...
        ["conjure_food", "Invocation de nourriture", "Invoque 2 portions de pain qui restaurent de la santé une fois mangées. Les rangs supérieurs invoquent des mets plus nourrissants."],
        ...
        ["pyroblast", "Pyroexplosion", "Projette un immense rocher embrasé qui inflige {damage} points de dégâts de Feu et des dégâts supplémentaires sur la durée."],
        ...
        ["garrote", "Garrot", "Garrotte l'ennemi, infligeant des dégâts immédiats et le faisant saigner de {damage} pendant 18 s. Vous devez être camouflé. Confère 1 point de combo."],
        ["cheap_shot", "Coup bas", "Frappe la cible, l'étourdissant pendant 4 s. Vous devez être camouflé. Confère 2 points de combo."],
        ["sap", "Assommer", "Neutralise la cible pendant 8 s. Vous devez être camouflé et hors combat. Le moindre dégât rompt l'effet."],
        ["crippling_poison", "Poison affaiblissant", "Frappe la cible avec un poison affaiblissant, infligeant {damage} dégâts de Nature et réduisant sa vitesse de déplacement de 50% pendant 12 s."],
        ["expose_armor", "Exposer l'armure", "Coup de grâce qui expose la cible, réduisant son armure. Plus vous dépensez de points de combo, plus l'entaille est profonde."],
        ["rupture", "Rupture", "Coup de grâce qui blesse la cible, la faisant saigner de {damage} pendant 16 s."],
        ["vanish", "Disparition", "Vous disparaissez et entrez en Camouflage, même en plein combat. Vous vous déplacez 30% plus lentement tant que vous êtes dissimulé. Dure jusqu'à 10 s."],
        ["instant_poison", "Poison instantané", "Enduit votre arme pendant 30 min, chacune de vos attaques en mêlée infligeant 8 dégâts de Nature supplémentaires."],
        ["deadly_poison", "Poison mortel", "Enduit votre arme pendant 30 min, chacune de vos attaques en mêlée infligeant 14 dégâts de Nature supplémentaires."],
        ["blind", "Cécité", "Aveugle la cible, la faisant errer désorientée pendant 8 s. Le moindre dégât rompt l'effet."],
        ["garrote", "Garrot", "Garrotte l'ennemi, infligeant des dégâts immédiats et le faisant saigner de {damage} pendant 18 s. Vous devez être camouflé. Confère 1 point de combo."],
        ["cheap_shot", "Coup bas", "Frappe la cible, l'étourdissant pendant 4 s. Vous devez être camouflé. Confère 2 points de combo."],
        ["sap", "Assommer", "Neutralise la cible pendant 8 s. Vous devez être camouflé et hors combat. Le moindre dégât rompt l'effet."],
        ["crippling_poison", "Poison affaiblissant", "Frappe la cible avec un poison affaiblissant, infligeant {damage} dégâts de Nature et réduisant sa vitesse de déplacement de 50% pendant 12 s."],
        ...
        ["retribution_aura", "Aura de châtiment", "Vous entoure d'énergie sacrée pendant 30 min et inflige 5 dégâts Sacrés à tout ennemi qui vous frappe en mêlée."],
        ...
        ["flametongue_weapon", "Arme Langue de feu", "Imprègne votre arme de feu élémentaire: chaque frappe inflige 8 points de dégâts de Feu supplémentaires pendant 5 min."],
        ...
        ["frostbrand_weapon", "Arme de givre", "Imprègne votre arme de givre mordant : chaque coup inflige 8 points de dégâts supplémentaires pendant 5 min."],
        ...
        ["travel_form", "Forme de voyage", "Prend une forme de voyage rapide, augmentant la vitesse de déplacement de 40%. Inutilisable en combat."],
        ...
        ["hibernate", "Hibernation", "Plonge la cible dans un sommeil profond pendant 8 s maximum. Tout dégât la réveille."],
        ["dash", "Sprint", "Bondit en avant, augmentant la vitesse de déplacement de 50% pendant 15 s. Forme de félin uniquement."],
        ["pounce", "Bondir", "Ouverture furtive qui étourdit la cible pendant 2 s. Confère 1 point de combo. Forme de félin uniquement."],
        ["insect_swarm", "Nuée d'insectes", "L'ennemi est assailli par une nuée d'insectes, subissant {damage} points de dégâts de Nature sur 12 s."],
        ["tigers_fury", "Furie du tigre", "Augmente la puissance d'attaque de 40 pendant 6 s. Forme de félin uniquement."],
        ["rip", "Lacération", "Coup de grâce qui inflige des dégâts de saignement sur 12 s. Consomme les points de combo. Forme de félin uniquement."],
  ...
  it_IT: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["demoralizing_shout", "Urlo Demoralizzante", "Lancia un urlo spaventoso, riducendo la potenza d'attacco di tutti i nemici vicini di 30 per 30 sec."],
        ...
        ["conjure_food", "Evoca Cibo", "Evoca 2 porzioni di pane che ripristinano salute quando mangiate. I ranghi superiori evocano cibo più sostanzioso."],
        ...
        ["pyroblast", "Piroesplosione", "Scaglia un immenso masso infuocato che infligge {damage} danni da Fuoco più danni aggiuntivi nel tempo."],
        ...
        ["garrote", "Garrota", "Garrota il nemico, infliggendo danni immediati e provocando sanguinamento per {damage} in 18 sec. Devi essere furtivo. Conferisce 1 punto combo."],
        ["cheap_shot", "Colpo Furtivo", "Colpisce il bersaglio, stordendolo per 4 sec. Devi essere furtivo. Conferisce 2 punti combo."],
        ["sap", "Tramortimento", "Incapacita il bersaglio per 8 sec. Devi essere furtivo e fuori dal combattimento. Qualsiasi danno interrompe l'effetto."],
        ["crippling_poison", "Veleno Immobilizzante", "Colpisce il bersaglio con un veleno immobilizzante, infliggendo {damage} danni della Natura e rallentando la sua velocità di movimento del 50% per 12 sec."],
        ["expose_armor", "Esposizione Corazza", "Mossa finale che espone il bersaglio, riducendone la corazza. Più punti combo spesi approfondiscono il taglio."],
        ["rupture", "Lacerazione", "Mossa finale che ferisce il bersaglio, provocando sanguinamento per {damage} in 16 sec."],
        ["vanish", "Eclissarsi", "Scompari dalla vista, entrando in Furtività anche in combattimento. Ti muovi il 30% più lentamente mentre sei nascosto. Dura fino a 10 sec."],
        ["instant_poison", "Veleno Istantaneo", "Ricopre la tua arma per 30 min, facendo sì che ognuno dei tuoi attacchi in mischia infligga 8 danni della Natura aggiuntivi."],
        ["deadly_poison", "Veleno Letale", "Ricopre la tua arma per 30 min, facendo sì che ognuno dei tuoi attacchi in mischia infligga 14 danni della Natura aggiuntivi."],
        ["blind", "Accecamento", "Acceca il bersaglio, facendolo vagare disorientato per 8 sec. Qualsiasi danno interrompe l'effetto."],
        ...
        ["retribution_aura", "Aura di retribuzione", "Ti circonda di energia sacra per 30 min, infliggendo 5 danni Sacri a ogni nemico che ti colpisce in mischia."],
        ...
        ["flametongue_weapon", "Arma Linguafiamma", "Imbeve la tua arma di fuoco elementale: ogni colpo infligge 8 danni da Fuoco aggiuntivi per 5 min."],
        ...
        ["frostbrand_weapon", "Arma del Gelo", "Permea la tua arma di gelo pungente: ogni colpo infligge 8 danni aggiuntivi per 5 min."],
        ...
        ["travel_form", "Forma da Viaggio", "Assume una rapida forma da viaggio, aumentando la velocità di movimento del 40%. Non utilizzabile in combattimento."],
        ...
        ["hibernate", "Letargo", "Costringe il bersaglio in un sonno profondo per un massimo di 8 sec. Qualsiasi danno lo risveglia."],
        ["dash", "Scatto", "Scatta in avanti, aumentando la velocità di movimento del 50% per 15 sec. Solo Forma Felina."],
        ["pounce", "Balzo", "Apertura furtiva che stordisce il bersaglio per 2 sec. Conferisce 1 punto combo. Solo Forma Felina."],
        ["insect_swarm", "Sciame d'Insetti", "Il nemico è assalito da uno sciame di insetti, subendo {damage} danni da Natura in 12 sec."],
        ["tigers_fury", "Furia della Tigre", "Aumenta la potenza d'attacco di 40 per 6 sec. Solo Forma Felina."],
        ["rip", "Squartare", "Mossa finale che infligge danni da sanguinamento in 12 sec. Consuma i punti combo. Solo Forma Felina."],
  ...
  de_DE: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["demoralizing_shout", "Demoralisierender Ruf", "Stößt einen furchterregenden Ruf aus und verringert die Angriffskraft aller nahen Gegner 30 Sek. lang um 30."],
        ...
        ["conjure_food", "Nahrung herbeizaubern", "Beschwört 2 Portionen Brot, die beim Essen Gesundheit wiederherstellen. Höhere Ränge beschwören nahrhaftere Speisen."],
        ...
        ["pyroblast", "Pyroschlag", "Schleudert einen gewaltigen Feuerbrocken, der {damage} Feuerschaden sowie zusätzlichen Schaden über Zeit verursacht."],
        ...
        ["garrote", "Erwürgen", "Erwürgt den Gegner, verursacht sofort Schaden und lässt ihn 18 Sek. lang um {damage} bluten. Erfordert Verstohlenheit. Gewährt 1 Combopunkt."],
        ["cheap_shot", "Wilder Hieb", "Trifft das Ziel und betäubt es 4 Sek. lang. Erfordert Verstohlenheit. Gewährt 2 Combopunkte."],
        ["sap", "Kopfnuss", "Macht das Ziel 8 Sek. lang handlungsunfähig. Erfordert Verstohlenheit und außerhalb des Kampfes zu sein. Jeder Schaden bricht den Effekt."],
        ["crippling_poison", "Lähmendes Gift", "Trifft das Ziel mit einem lähmenden Gift, verursacht {damage} Naturschaden und verringert sein Bewegungstempo 12 Sek. lang um 50%."],
        ["expose_armor", "Rüstung zerreißen", "Finishing-Move, der das Ziel entblößt und seine Rüstung verringert. Mehr eingesetzte Combopunkte führen zu einem tieferen Schnitt."],
        ["rupture", "Rupturieren", "Finishing-Move, der das Ziel verwundet und es 16 Sek. lang um {damage} bluten lässt."],
        ["vanish", "Verschwinden", "Verschwindet aus dem Blickfeld und tretet selbst im Kampf in Verstohlenheit. Ihr bewegt euch 30% langsamer, solange ihr verborgen seid. Hält bis zu 10 Sek. an."],
        ["instant_poison", "Sofortgift", "Überzieht eure Waffe 30 Min. lang, sodass jeder eurer Nahkampfschwünge 8 zusätzlichen Naturschaden verursacht."],
        ["deadly_poison", "Tödliches Gift", "Überzieht eure Waffe 30 Min. lang, sodass jeder eurer Nahkampfschwünge 14 zusätzlichen Naturschaden verursacht."],
        ["blind", "Blenden", "Blendet das Ziel, sodass es 8 Sek. lang desorientiert umherirrt. Jeder Schaden bricht den Effekt."],
        ...
        ["retribution_aura", "Vergeltungsaura", "Umgibt Euch 30 Min. lang mit heiliger Energie und fügt jedem Gegner, der Euch im Nahkampf trifft, 5 Heiligschaden zu."],
        ...
        ["flametongue_weapon", "Flammenzungenwaffe", "Erfüllt eure Waffe mit elementarem Feuer: Jeder Schlag verursacht 8 zusätzlichen Feuerschaden für 5 Min."],
        ...
        ["frostbrand_weapon", "Frostbrandwaffe", "Verzaubert Eure Waffe mit beißendem Frost: Jeder Schlag verursacht 8 zusätzlichen Schaden für 5 Min."],
        ...
        ["travel_form", "Reisegestalt", "Nehmt eine flinke Reisegestalt an, was das Lauftempo um 40% erhöht. Im Kampf nicht einsetzbar."],
        ...
        ["hibernate", "Winterschlaf", "Versetzt das Ziel bis zu 8 Sek. in tiefen Schlaf. Jeglicher Schaden weckt es auf."],
        ["dash", "Sprint", "Sprintet vorwärts und erhöht das Lauftempo 15 Sek. lang um 50%. Nur in Katzengestalt."],
        ["pounce", "Anspringen", "Ein Eröffnungsangriff aus der Verstohlenheit, der das Ziel 2 Sek. lang betäubt. Gewährt 1 Combopunkt. Nur in Katzengestalt."],
        ["insect_swarm", "Insektenschwarm", "Der Gegner wird von Insekten umschwärmt und erleidet {damage} Naturschaden über 12 Sek."],
        ["tigers_fury", "Zorn des Tigers", "Erhöht die Angriffskraft 6 Sek. lang um 40. Nur in Katzengestalt."],
        ["rip", "Zerfetzen", "Finishing-Move, der über 12 Sek. Blutungsschaden verursacht. Verbraucht Combopunkte. Nur in Katzengestalt."],
  ...
  zh_CN: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["demoralizing_shout", "挫志怒吼", "发出可怕的怒吼，使附近所有敌人的攻击强度降低 30，持续 30 秒。"],
        ...
        ["pyroblast", "炎爆术", "投掷一颗巨大的火焰陨石，造成 {damage} 点火焰伤害，并在一段时间内造成额外伤害。"],
        ...
        ["garrote", "锁喉", "勒住敌人的喉咙，立即造成伤害，并使其流血，在 18 秒内受到 {damage} 点伤害。必须处于潜行状态。奖励 1 个连击点。"],
        ["cheap_shot", "偷袭", "攻击目标，使其昏迷 4 秒。必须处于潜行状态。奖励 2 个连击点。"],
        ["sap", "闷棍", "使目标无法行动，持续 8 秒。必须处于潜行状态且不在战斗中。任何伤害都会打破效果。"],
        ["crippling_poison", "致残毒药", "以致残毒药攻击目标，造成 {damage} 点自然伤害，并使其移动速度降低 50%，持续 12 秒。"],
        ["expose_armor", "破甲", "终结技，使目标护甲值降低。消耗的连击点越多，削减得越深。"],
        ["rupture", "割裂", "终结技，撕裂目标，使其流血，在 16 秒内受到 {damage} 点伤害。"],
        ["vanish", "消失", "从视野中消失，即使在战斗中也能进入潜行状态。隐身时你的移动速度降低 30%。持续最多 10 秒。"],
        ["instant_poison", "速效毒药", "为你的武器淬毒，持续 30 分钟，使你的每次近战攻击额外造成 8 点自然伤害。"],
        ["deadly_poison", "致命毒药", "为你的武器淬毒，持续 30 分钟，使你的每次近战攻击额外造成 14 点自然伤害。"],
        ["blind", "致盲", "使目标失明，导致其神志不清地四处游荡，持续 8 秒。任何伤害都会打破效果。"],
        ...
        ["retribution_aura", "惩戒光环", "以神圣能量环绕自身，持续 30 分钟，对任何近战攻击你的敌人造成 5 点神圣伤害。"],
        ...
        ["flametongue_weapon", "火舌武器", "用元素之火灌注你的武器：每次挥击额外造成 8 点火焰伤害，持续 5 分钟。"],
        ["frost_shock", "冰霜震击", "立即以冰霜冲击目标，造成 {damage} 点冰霜伤害，并使其移动速度降低 50%，持续 8 秒。"],
        ["frostbrand_weapon", "霜刃武器", "为你的武器附上刺骨寒霜：每次挥击额外造成 8 点伤害，持续 5 分钟。"],
  ...
  zh_TW: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["demoralizing_shout", "挫志怒吼", "發出可怕的怒吼，使附近所有敵人的攻擊強度降低 30，持續 30 秒。"],
        ...
        ["pyroblast", "炎爆術", "投擲一顆巨大的火焰隕石，造成 {damage} 點火焰傷害，並在一段時間內造成額外傷害。"],
        ...
        ["garrote", "鎖喉", "勒住敵人的咽喉，立即造成傷害，並使其在 18 秒內流血損失 {damage} 點生命。必須處於潛行狀態。獎勵 1 個連擊點。"],
        ["cheap_shot", "偷襲", "攻擊目標，使其昏迷 4 秒。必須處於潛行狀態。獎勵 2 個連擊點。"],
        ["sap", "悶棍", "使目標無法行動，持續 8 秒。必須處於潛行狀態且脫離戰鬥。任何傷害都會破除此效果。"],
        ["crippling_poison", "致殘毒藥", "以致殘毒藥攻擊目標，造成 {damage} 點自然傷害，並使其移動速度降低 50%，持續 12 秒。"],
        ["expose_armor", "破甲", "終結技，使目標破綻盡露，降低其護甲。消耗越多連擊點，撕裂得越深。"],
        ["rupture", "割裂", "終結技，撕裂目標的傷口，使其在 16 秒內流血損失 {damage} 點生命。"],
        ["vanish", "消失", "從視野中消失，即使在戰鬥中也能進入潛行狀態。隱身時你的移動速度降低 30%。最多持續 10 秒。"],
        ["instant_poison", "速效毒藥", "在你的武器上塗抹毒藥，持續 30 分鐘，使你的每次近戰揮擊額外造成 8 點自然傷害。"],
        ["deadly_poison", "致命毒藥", "在你的武器上塗抹毒藥，持續 30 分鐘，使你的每次近戰揮擊額外造成 14 點自然傷害。"],
        ...
        ["retribution_aura", "懲戒光環", "以神聖能量環繞自身，持續 30 分鐘，對任何近戰攻擊你的敵人造成 5 點神聖傷害。"],
        ...
        ["flametongue_weapon", "火舌武器", "用元素之火灌注你的武器：每次揮擊額外造成 8 點火焰傷害，持續 5 分鐘。"],
        ["frost_shock", "冰霜震擊", "立即以冰霜衝擊目標，造成 {damage} 點冰霜傷害，並使其移動速度降低 50%，持續 8 秒。"],
        ["frostbrand_weapon", "霜刃武器", "為你的武器附上刺骨寒霜：每次揮擊額外造成 8 點傷害，持續 5 分鐘。"],
  ...
  ko_KR: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["demoralizing_shout", "사기의 외침", "무시무시한 고함을 질러 주위 모든 적의 전투력을 30만큼 30초 동안 감소시킵니다."],
        ...
        ["conjure_food", "음식 창조", "먹으면 생명력을 회복하는 빵 2개를 창조합니다. 높은 등급은 더 든든한 음식을 창조합니다."],
        ...
        ["pyroblast", "화염 폭발", "거대한 불덩이를 던져 {damage}의 화염 피해를 입히고 일정 시간에 걸쳐 추가 피해를 입힙니다."],
        ...
        ["garrote", "목조르기", "적의 목을 졸라 즉시 피해를 입히고 18초에 걸쳐 {damage}의 출혈 피해를 입힙니다. 은신 상태여야 합니다. 연계 점수 1점을 얻습니다."],
        ["cheap_shot", "비열한 습격", "대상을 가격해 4초 동안 기절시킵니다. 은신 상태여야 합니다. 연계 점수 2점을 얻습니다."],
        ["sap", "관자놀이 가격", "대상을 8초 동안 무력화합니다. 은신 상태이며 전투 중이 아니어야 합니다. 피해를 받으면 효과가 해제됩니다."],
        ["crippling_poison", "무력화 독", "대상을 무력화 독으로 가격해 {damage}의 자연 피해를 입히고 12초 동안 이동 속도를 50%만큼 감소시킵니다."],
        ["expose_armor", "방어구 노출", "대상의 약점을 드러내 방어도를 감소시키는 결정타입니다. 연계 점수를 많이 소모할수록 더 깊게 베어 들어갑니다."],
        ["rupture", "파열", "대상에게 상처를 입혀 16초에 걸쳐 {damage}의 출혈 피해를 입히는 결정타입니다."],
        ["vanish", "소멸", "시야에서 사라져 전투 중에도 은신 상태가 됩니다. 숨어 있는 동안 이동 속도가 30% 감소합니다. 최대 10초 동안 지속됩니다."],
        ["instant_poison", "속효성 독", "30분 동안 무기에 독을 발라 근접 공격마다 8의 추가 자연 피해를 입힙니다."],
        ["deadly_poison", "맹독", "30분 동안 무기에 독을 발라 근접 공격마다 14의 추가 자연 피해를 입힙니다."],
        ["blind", "실명", "대상의 눈을 멀게 해 8초 동안 방향을 잃고 헤매게 만듭니다. 피해를 받으면 효과가 해제됩니다."],
        ...
        ["retribution_aura", "응징의 오라", "30분 동안 자신을 신성한 기운으로 감싸 근접 공격을 가하는 적에게 5의 신성 피해를 입힙니다."],
        ...
        ["flametongue_weapon", "불꽃혀 무기", "무기에 원소의 불꽃을 부여하여 각 공격마다 8의 추가 화염 피해를 입힙니다. 5분간 지속됩니다."],
        ["frost_shock", "냉기 충격", "대상을 즉시 냉기로 강타해 {damage}의 냉기 피해를 입히고 8초 동안 이동 속도를 50%만큼 감소시킵니다."],
        ["frostbrand_weapon", "서리낙인 무기", "무기에 살을 에는 서리를 부여해 매 공격마다 8의 추가 피해를 입힙니다. 5분 동안 지속됩니다."],
        ...
        ["travel_form", "여행 형태", "날렵한 여행 형태로 변신하여 이동 속도를 40% 증가시킵니다. 전투 중에는 사용할 수 없습니다."],
        ["enrage", "격노", "즉시 분노 20을 생성합니다. 곰 변신 전용."],
        ["bash", "곤봉 세례", "대상을 2초 동안 기절시킵니다. 곰 변신 전용."],
        ["faerie_fire", "요정의 불꽃", "대상의 방어도를 40초 동안 35만큼 감소시킵니다."],
        ["hibernate", "동면", "대상을 최대 8초 동안 깊은 잠에 빠뜨립니다. 피해를 입으면 깨어납니다."],
        ["dash", "질주", "앞으로 돌진하여 이동 속도를 15초 동안 50% 증가시킵니다. 표범 변신 전용."],
        ["pounce", "덮치기", "은신 상태에서 사용하는 시작 공격으로 대상을 2초 동안 기절시킵니다. 연계 점수 1점을 얻습니다. 표범 변신 전용."],
        ["insect_swarm", "곤충 떼", "적이 곤충 떼에 휩싸여 12초에 걸쳐 {damage}의 자연 피해를 입습니다."],
        ["tigers_fury", "호랑이의 분노", "공격력을 6초 동안 40만큼 증가시킵니다. 표범 변신 전용."],
        ["rip", "찢기", "12초에 걸쳐 출혈 피해를 입히는 결정타입니다. 연계 점수를 소모합니다. 표범 변신 전용."],
  ...
  ja_JP: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["demoralizing_shout", "デモラライジングシャウト", "恐ろしい雄叫びを上げ、30秒間、周囲の敵すべての攻撃力を30減少させます。"],
        ...
        ["conjure_food", "食料の召喚", "食べると体力を回復するパンを2つ召喚します。高ランクではより滋養のある食料を召喚します。"],
        ...
        ["pyroblast", "パイロブラスト", "巨大な炎の塊を放ち、{damage} の火炎ダメージを与え、さらに一定時間追加ダメージを与えます。"],
        ...
        ["garrote", "ガロット", "敵を絞め、即座にダメージを与えるとともに、18秒かけて{damage}の出血ダメージを与えます。ステルス状態でなければなりません。コンボポイントを1獲得します。"],
        ["cheap_shot", "チープショット", "対象を打って4秒間スタンさせます。ステルス状態でなければなりません。コンボポイントを2獲得します。"],
        ["sap", "サップ", "対象を8秒間行動不能にします。ステルス状態かつ戦闘外でなければなりません。ダメージを受けると効果が切れます。"],
        ["crippling_poison", "クリップリング・ポイズン", "対象をクリップリング・ポイズンで攻撃し、{damage}の自然ダメージを与えるとともに、移動速度を12秒間50%低下させます。"],
        ["expose_armor", "エクスポーズ・アーマー", "対象の防御を崩し、アーマーを低下させるフィニッシュムーブです。消費したコンボポイントが多いほど、より深く切り込みます。"],
        ["rupture", "ラプチャー", "対象に傷を負わせ、16秒かけて{damage}の出血ダメージを与えるフィニッシュムーブです。"],
        ["vanish", "ヴァニッシュ", "視界から消え、戦闘中でもステルス状態に入ります。隠れている間は移動速度が30%低下します。最大10秒間持続します。"],
        ["instant_poison", "インスタント・ポイズン", "武器に30分間毒を塗り、近接攻撃ごとに8の追加自然ダメージを与えます。"],
        ["deadly_poison", "デッドリー・ポイズン", "武器に30分間毒を塗り、近接攻撃ごとに14の追加自然ダメージを与えます。"],
        ["blind", "ブラインド", "対象を盲目にし、8秒間混乱してさまよわせます。ダメージを受けると効果が切れます。"],
        ...
        ["retribution_aura", "懲罰のオーラ", "30分間、神聖なエネルギーで自身を包み、近接攻撃を仕掛けてきた敵に5の神聖ダメージを与えます。"],
        ...
        ["flametongue_weapon", "フレイムタンウェポン", "武器に元素の炎を付与し、攻撃ごとに8の追加炎ダメージを与えます。5分間持続します。"],
        ["frost_shock", "フロストショック", "対象を冷気で即座に打ち、{damage} の冷気ダメージを与え、8秒間、移動速度を50%低下させます。"],
        ["frostbrand_weapon", "フロストブランドウェポン", "武器に凍てつく霜を付与し、攻撃ごとに8の追加ダメージを与えます。5分間持続します。"],
        ...
        ["travel_form", "トラベルフォーム", "素早い移動形態になり、移動速度を40%上昇させます。戦闘中は使用できません。"],
        ["enrage", "激怒", "即座にレイジを20生成します。ベアフォーム専用。"],
        ["bash", "殴打", "対象を2秒間スタンさせます。ベアフォーム専用。"],
        ["faerie_fire", "フェアリーファイア", "対象の防御力を40秒間35低下させます。"],
        ["hibernate", "ハイバネート", "対象を最大8秒間深い眠りに落とします。ダメージを受けると目を覚まします。"],
        ["dash", "ダッシュ", "前方へ駆け出し、移動速度を15秒間50%上昇させます。キャットフォーム専用。"],
        ["pounce", "パウンス", "隠密状態から放つ先制攻撃で、対象を2秒間スタンさせます。コンボポイントを1獲得します。キャットフォーム専用。"],
        ["insect_swarm", "インセクトスウォーム", "敵が虫の群れに襲われ、12秒かけて{damage}の自然ダメージを受けます。"],
        ["tigers_fury", "タイガーフューリー", "攻撃力を6秒間40上昇させます。キャットフォーム専用。"],
        ["rip", "リップ", "12秒かけて出血ダメージを与えるフィニッシュムーブです。コンボポイントを消費します。キャットフォーム専用。"],
  ...
  pt_BR: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["demoralizing_shout", "Grito Desmoralizante", "Solta um grito assustador, reduzindo o poder de ataque de todos os inimigos próximos em 30 por 30 seg."],
        ...
        ["conjure_food", "Conjurar Comida", "Conjura 2 porções de pão que restauram vida quando comidas. Graus superiores conjuram alimentos mais substanciais."],
        ...
        ["pyroblast", "Piroexplosão", "Arremessa uma imensa rocha flamejante que causa {damage} de dano de Fogo mais dano adicional ao longo do tempo."],
        ...
        ["garrote", "Garrote", "Garroteia o inimigo, causando dano imediato e fazendo-o sangrar por {damage} ao longo de 18 s. Requer modo furtivo. Concede 1 ponto de combo."],
        ["cheap_shot", "Golpe Baixo", "Atinge o alvo, atordoando-o por 4 s. Requer modo furtivo. Concede 2 pontos de combo."],
        ["sap", "Nocaute", "Incapacita o alvo por 8 s. Requer modo furtivo e estar fora de combate. Qualquer dano quebra o efeito."],
        ["crippling_poison", "Veneno Aleijante", "Atinge o alvo com um veneno aleijante, causando {damage} de dano da Natureza e reduzindo sua velocidade de movimento em 50% por 12 s."],
        ["expose_armor", "Expor Armadura", "Golpe final que expõe o alvo, reduzindo sua armadura. Mais pontos de combo gastos aprofundam o corte."],
        ["rupture", "Ruptura", "Golpe final que fere o alvo, fazendo-o sangrar por {damage} ao longo de 16 s."],
        ["vanish", "Desaparecer", "Some de vista, entrando em modo furtivo mesmo em combate. Você se move 30% mais devagar enquanto escondido. Dura até 10 s."],
        ["instant_poison", "Veneno Instantâneo", "Reveste sua arma por 30 min, fazendo cada um de seus golpes corpo a corpo causar 8 de dano adicional da Natureza."],
        ["deadly_poison", "Veneno Mortal", "Reveste sua arma por 30 min, fazendo cada um de seus golpes corpo a corpo causar 14 de dano adicional da Natureza."],
        ["blind", "Cegar", "Cega o alvo, fazendo-o vagar desorientado por 8 s. Qualquer dano quebra o efeito."],
        ...
        ["retribution_aura", "Aura de Retribuição", "Envolve você em energia sagrada por 30 min, causando 5 de dano Sagrado a qualquer inimigo que o atinja corpo a corpo."],
        ...
        ["flametongue_weapon", "Arma Língua de Fogo", "Imbui sua arma com fogo elemental: cada golpe causa 8 de dano de Fogo adicional por 5 min."],
        ...
        ["frostbrand_weapon", "Arma de Gelo", "Imbui sua arma com gelo cortante: cada golpe causa 8 de dano adicional por 5 min."],
        ...
        ["travel_form", "Forma de Viagem", "Assume uma rápida forma de viagem, aumentando a velocidade de movimento em 40%. Não pode ser usada em combate."],
        ...
        ["hibernate", "Hibernar", "Força o alvo a um sono profundo por até 8 s. Qualquer dano o desperta."],
        ["dash", "Corrida", "Dispara para a frente, aumentando a velocidade de movimento em 50% por 15 s. Apenas Forma Felina."],
        ["pounce", "Bote", "Abertura furtiva que atordoa o alvo por 2 s. Concede 1 ponto de combo. Apenas Forma Felina."],
        ["insect_swarm", "Enxame de Insetos", "O inimigo é atacado por um enxame de insetos, sofrendo {damage} de dano de Natureza ao longo de 12 s."],
        ["tigers_fury", "Fúria do Tigre", "Aumenta o poder de ataque em 40 por 6 s. Apenas Forma Felina."],
        ["rip", "Rasgar", "Golpe final que causa dano de sangramento ao longo de 12 s. Consome pontos de combo. Apenas Forma Felina."],
  ...
  ru_RU: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["demoralizing_shout", "Деморализующий крик", "Издает устрашающий крик, снижая силу атаки всех противников поблизости на 30 на 30 сек."],
        ...
        ["conjure_food", "Сотворение пищи", "Создаёт 2 порции хлеба, восстанавливающего здоровье при употреблении. Высшие ранги создают более сытную пищу."],
        ...
        ["pyroblast", "Огненный взрыв", "Обрушивает на врага громадный пылающий камень, наносящий {damage} ед. урона от огня и дополнительный урон с течением времени."],
        ...
        ["garrote", "Гаррота", "Душит врага гарротой, нанося урон сразу и {damage} от кровотечения в течение 18 сек. Требуется незаметность. Дает 1 очко серии."],
        ["cheap_shot", "Удар исподтишка", "Бьет цель, оглушая ее на 4 сек. Требуется незаметность. Дает 2 очка серии."],
        ["sap", "Ошеломление", "Выводит цель из строя на 8 сек. Требуется незаметность и нахождение вне боя. Любой урон прерывает эффект."],
        ["crippling_poison", "Калечащий яд", "Поражает цель калечащим ядом, нанося {damage} ед. урона от сил природы и замедляя ее скорость передвижения на 50% в течение 12 сек."],
        ["expose_armor", "Вскрытие брони", "Завершающий прием, который оголяет цель, снижая ее броню. Чем больше затрачено очков серии, тем глубже разрез."],
        ["rupture", "Кровопускание", "Завершающий прием, который ранит цель, вызывая кровотечение на {damage} в течение 16 сек."],
        ["vanish", "Исчезновение", "Исчезает из виду, входя в незаметность даже в бою. Пока вы скрыты, вы двигаетесь на 30% медленнее. Длится до 10 сек."],
        ["instant_poison", "Быстродействующий яд", "Покрывает ваше оружие ядом на 30 мин, заставляя каждый ваш удар в ближнем бою наносить 8 дополнительных ед. урона от сил природы."],
        ["deadly_poison", "Смертельный яд", "Покрывает ваше оружие ядом на 30 мин, заставляя каждый ваш удар в ближнем бою наносить 14 дополнительных ед. урона от сил природы."],
        ["blind", "Ослепление", "Ослепляет цель, заставляя ее дезориентированно бродить в течение 8 сек. Любой урон прерывает эффект."],
        ...
        ["retribution_aura", "Аура воздаяния", "Окружает вас священной энергией на 30 мин и наносит 5 ед. урона светлой магией любому врагу, атакующему вас в ближнем бою."],
        ...
        ["flametongue_weapon", "Оружие огненного языка", "Наделяет ваше оружие стихийным огнем: каждый удар наносит 8 дополнительного урона от огня в течение 5 мин."],
        ...
        ["frostbrand_weapon", "Ледяное оружие", "Наделяет ваше оружие кусающим холодом: каждый удар наносит 8 ед. дополнительного урона в течение 5 мин."],
        ...
        ["travel_form", "Походная форма", "Принимает быструю походную форму, повышая скорость передвижения на 40%. Нельзя использовать в бою."],
        ...
        ["hibernate", "Спячка", "Погружает цель в глубокий сон на срок до 8 сек. Любой урон пробуждает ее."],
        ["dash", "Рывок", "Рывок вперед, повышающий скорость передвижения на 50% на 15 сек. Только в облике кошки."],
        ["pounce", "Прыжок", "Открывающая атака из скрытности, оглушающая цель на 2 сек. Дает 1 прием серии. Только в облике кошки."],
        ["insect_swarm", "Рой насекомых", "Враг атакован роем насекомых и получает {damage} ед. урона от сил Природы в течение 12 сек."],
        ["tigers_fury", "Ярость тигра", "Повышает силу атаки на 40 на 6 сек. Только в облике кошки."],
        ["rip", "Разрывание", "Завершающий прием, наносящий урон от кровотечения в течение 12 сек. Расходует приемы серии. Только в облике кошки."],
...
export const en = {
  ...
  // in English; sim_i18n.ts re-localizes them through t() against these keys (the
  // generated-overlay path, mirroring game.talents.readout). Locale overlays are
  // English-filled + marked pending by the i18n build until a translation pass.
  sim: {
    delve: {
  ...
  // $N / $C in the source narrative resolve to {playerName} / {className}.
  delveUi: {
    board: {
      title: "Delve Board",
      enter: "Enter Delve",
