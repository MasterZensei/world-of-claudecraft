...
export const es_ES: Partial<Record<TranslationKey, string>> = {
  ...
  "delveUi.blessing.chapel_candle": "Vela de capilla: incursión más segura, una Marca menos al completarla.",
  ...
  "delveUi.boss.varric.mid60": "El Diácono Varric lee nombres del registro con un júbilo tembloroso.",
  "delveUi.boss.varric.pull": "Pisas el polvo sagrado con un propósito impuro. Arrodíllate y deja que te cuenten.",
  ...
  "delveUi.companion.tessa.combat_start": "Afírmate, {playerName}. Aquí los muertos están inquietos.",
  ...
  "delveUi.intro.heroic": "Las puertas se cierran con un quejido a tu espalda. Los nombres rascan la piedra como uñas. La vela de Tessa arde azul. \"Ya no están llamando a los muertos, {playerName}. Están respondiendo a algo.\"",
  "delveUi.intro.normal": "La escalera es fría y oscura. Piedras sagradas rotas cubren el descenso, y una suave nota de campana flota en el aire húmedo. La Acólita Tessa susurra: \"El relicario no debería estar abierto tan abajo. No te alejes, {playerName}.\"",
  ...
  "delveUi.lore.first_collapse": "Los registros de la capilla anotan el primer hundimiento: piedras sagradas resquebrajadas, estantes inclinados y una nota de campana oída desde bajo tierra.",
  "delveUi.lore.gravecaller_mark": "Un sigilo raspado en la madera de un ataúd, no el sello de Morthen, sino una marca de invocasepulcros más antigua, anterior a la Cripta Hueca.",
  "delveUi.lore.tessa_note": "Un retazo doblado con la letra de Tessa: \"Si los registros cambian mientras estamos abajo, fíate de la vela, no de las voces.\"",
  "delveUi.module.reliquary_saintless_hall": "Estatuas con los rostros cincelados con un odio meticuloso.",
  "delveUi.module.reliquary_sunken_ossuary": "El agua se filtra por los estantes funerarios, arrastrando vieja ceniza en arroyos de plata y negro.",
  ...
  "delveUi.run.failed": "La incursión a la Profundidad ha fracasado. Vuelves con el Hermano Halven.",
  ...
  "entities.delves.collapsed_reliquary.leaveText": "Trepas de vuelta hasta el Hermano Halven, en la ruina del relicario.",
  ...
  "sim.delve.bossChest": "El jefe cae. Un cofre de relicario protegido se alza en el estrado. Fuerza su cerradura para reclamar tu botín.",
  ...
  "sim.delve.companionMarksRequired": "Necesitas {marks} Marcas de Profundidad para mejorar a {name}.",
  ...
  "sim.delve.mechanismOpen": "Un mecanismo se abre con un chasquido cerca. Se abre un pasaje hacia el norte. Busca el portal de salida más adelante.",
  ...
  "sim.delve.tombstoneHint": "Un pasaje de lápida se abre hacia el norte cuando la sala queda despejada.",
  "sim.delve.tombstoneOpen": "Un pasaje de lápida sellado se abre con un chirrido hacia el norte. Entra en él para continuar.",
  ...
  "sim.lockpick.lastPickSnaps": "La última ganzúa se parte. La cerradura se atasca: el cofre se pierde a menos que vuelvas a superar la Profundidad.",
  "sim.lockpick.lockJammed": "La cerradura está demasiado atascada para forzarla. Vuelve a superar la Profundidad para otro intento.",
