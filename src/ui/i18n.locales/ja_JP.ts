...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.tips.joinChannels':
    'ヒント：/join world または /join lfg と入力すると、レルム全体のプレイヤーとチャットできます。',
  ...
  'mode.onlineDesc':
    'レルムにログインします。キャラクターはサーバー上に保存され、オンラインの他の全プレイヤーと同じ世界を共有します。',
  ...
  'entities.abilities.travel_form.description':
    '素早い移動形態に即座に変身し、移動速度を40%上昇させます。変身中は他のアビリティを使用できませんが、戦闘中でも戦闘外でも変身を切り替えられるため、逃走に最適です。',
  ...
  'entities.abilities.summon_succubus.description':
    'ウォーロックの命令に従うサキュバスを召喚します。サキュバスは素早く攻撃し近接戦闘で大きなダメージを与える脆い悪魔です。新たな悪魔を召喚すると現在の悪魔は解放されます。悪魔は一度に1体しか従えられません。',
  'entities.abilities.summon_felhunter.name': 'フェルハンターの召喚',
  'entities.abilities.summon_felhunter.description':
    'ウォーロックの命令に従うフェルハンターを召喚します。フェルハンターはシャドウバイトで遠くから敵を悩ませ、呪文の使い手を狩るのに長けています。新たな悪魔を召喚すると現在の悪魔は解放されます。悪魔は一度に1体しか従えられません。',
  'entities.abilities.summon_felguard.name': 'フェルガードの召喚',
  'entities.abilities.summon_felguard.description':
    'ウォーロックの命令に従うフェルガードを召喚します。フェルガードは戦場に踏み込んで持ちこたえる頑丈な近接悪魔です。新たな悪魔を召喚すると現在の悪魔は解放されます。悪魔は一度に1体しか従えられません。',
  'entities.abilities.summon_infernal.name': 'インファーナルの召喚',
  'entities.abilities.summon_infernal.description':
    'インファーナルを意のままに束縛します。圧倒的な近接攻撃と、あらゆる悪魔の中で最も深い生命力と防御力を備えた巨大な破壊兵器です。長い再使用時間がその純然たる力を制限します。新たな悪魔を召喚すると現在の悪魔は解放されます。悪魔は一度に1体しか従えられません。',
  'entities.abilities.summon_doomguard.name': 'ドゥームガードの召喚',
  'entities.abilities.summon_doomguard.description':
    'ドゥームガードを意のままに束縛します。遠方から強力なシャドウダメージを降らせるエリート悪魔です。長い再使用時間がその破壊的な力を制限します。新たな悪魔を召喚すると現在の悪魔は解放されます。悪魔は一度に1体しか従えられません。',
  ...
  'entities.quests.q_spiders.text':
    'ウェブウッドの潜伏者は薬布に使う絹を出しますが、増えすぎました。6匹を倒し、絹腺を4つ切り取ってください。',
  ...
  'entities.quests.q_murlocs.text':
    '鏡の湖で二十年漁をしてきましたが、魚人が浅瀬から這い出しました。泥ひれを8体追い払い、群れに注意を。',
  ...
  'entities.quests.q_mine.text':
    'よい銅脈を掘り当てた途端、コボルドが丘から湧きました。トンネルラット掘りを10体倒してください。',
  ...
  'entities.quests.q_rite.text':
    '墓所を開くには、束縛の儀式で生者の道を作る必要があります。祝福された獣脂を4つ、幽霊のエッセンスを6つ集めてください。',
  ...
  'entities.quests.q_gravecallers_trail.completion':
    'モーセンは北の湿地のミストコーラーに書いていました。{playerName}、一派は死んでいません。ただ待っていたのです。',
  ...
  'entities.quests.q_fenbridge_muster.text':
    'モーセンの書き物は北の湿地の主を名指ししています。{playerName}、私は偶然を信じません。フェンブリッジの門柱から召集令を取り、番人へ届けてください。',
  ...
  'entities.quests.q_deepfen.text':
    'ディープフェンの魚人が湖底から何かを引き上げています。スナッパーを12体討ち、その理由を探りましょう。',
  ...
  'entities.quests.q_deepfen_purge.text':
    '偶像は教団のものです。魚人は古い悪を湿地からすくい上げています。浅瀬へ戻り、さらに14体倒してください。',
  ...
  'entities.quests.q_summoners.completion':
    '暗号はすべて助祭ヴォスの副署で、砦のミストコーラー宛てです。モーセンの主です、{playerName}。見つけました。',
  ...
  'entities.quests.q_bastion_door.text':
    '沈んだ砦はミストコーラーの場所で、扉は墓石で封じられています。{playerName}、護り石を一つ持ってきてください。',
  ...
  'entities.quests.q_olen.text':
    'オレンは砦を守って溺れ、今は操り人形として同じ扉を守っています。{playerName}、四人の仲間と下り、眠らせてください。',
  ...
  'entities.quests.q_mistcaller.text':
    'ヴァエルは砦の底にいます。百人を溺れさせ、軍を作った声です。四人の仲間と終わらせてください、{playerName}。',
  ...
  'entities.quests.q_glowing_wax.text':
    '坑夫のろうは光り、{playerName}、鼓動のように温かい。キャディスの研究のために6塊持ってきてください。',
  ...
  'guide.home.world.marshBlurb':
    '沈んだ沼地と波に削られた遺跡。マーロックや、それ以上に厄介なものが棲む。',
  ...
  'guide.home.faq.a3':
    'はい。ブラウザですぐに遊べるシングルプレイモードに加え、共有のオンラインレルムもあります。',
  ...
  'guide.howToPlay.onlineBody':
    'みんなと一緒に共有のオンラインレルムで遊ぶか、ブラウザですぐに始められるオフラインワールドで基本を覚えるか、選べます。',
  ...
  'guide.worldPage.marshBlurb':
    '霧と廃墟に沈んだ国。浅瀬にはマーロックが群れ、水の底ではより古き何かがうごめいています。橋の町フェンブリッジから見張られています。',
  ...
  'guide.abilityHook.divine_protection':
    '状況が厳しいときにダメージを吸収する、素早いホーリーシールドです。',
  ...
  'guide.abilityHook.seal_of_righteousness':
    '一振りごとにホーリーダメージを付与し、ジャッジメントで消費します。',
  ...
  'guide.bestiary.flavor.mirejaw_frenzy':
    '戦いの最中に自らを暴れ狂う狂乱へと駆り立てる沼地のマーロック。騒がしく縄張り意識の強い群れの中で、最もやかましい一匹です。',
  ...
  'guide.worldPage.marshPlaceNotes':
    'フェンブリッジは唯一の乾いた道を守っています。プラウラー葦原とディープフェン浅瀬は沼地の獣とマーロックでひしめき、ウィドウの茂みは蜘蛛の糸が厚く張られ、水没の礼拝堂とトロルの塚にはより古き危険が潜み、グレイブコーラーの野営地にはカルトが立てこもり、沈んだ砦は沼地のインスタンス化された中心地です。',
