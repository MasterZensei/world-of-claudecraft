...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "entities.quests.q_nythraxis_scourges_end.text": "印戒已經打開道路，{playerName}，但敞開的陵墓還不是勝利。尼思拉克西斯曾是國王，而索恩峰地下的廢墟仍受他的意志束縛。帶上值得信任的盟友進入墓穴。在那不死王冠的命令傳到上方戰場之前，將它擊碎。",
  ...
  "entities.zones.eastbrook_vale.pois.8.label": "聖物庫山丘",
  ...
  "entities.items.kingsbane_last_oath.name": "弒王者，荊峰的最後誓言",
  "entities.items.crownforged_dreadhelm.name": "鑄冠恐懼頭盔",
  "entities.items.crownforged_warspaulders.name": "鑄冠戰肩甲",
  "entities.items.nighttalon_crown.name": "夜爪之冠",
  "entities.items.nighttalon_shoulderguards.name": "夜爪護肩",
  ...
  "entities.mobs.placeholder_boss.name": "試煉守衛",
  ...
  "entities.delves.delve_placeholder.enterText": "你向下深入淺層試煉墓穴。",
  "entities.delves.delve_placeholder.leaveText": "你爬回地面。",
  "entities.delves.delve_placeholder.name": "淺層試煉墓穴",
  ...
  "guide.home.world.marshBlurb": "沉沒的沼澤與潮水侵蝕的廢墟，是魚人與更危險生物的巢穴。",
  ...
  "guide.home.faq.a3": "可以。瀏覽器中提供即時的單人模式，另外還有共享的線上伺服器。",
  "guide.home.faq.q4": "達到最高等級需要多久？",
  "guide.home.faq.a4": "等級上限為 {cap} 級，需橫跨三座區域，透過任務、地城與探索達成。",
  "guide.home.community.heading": "加入這片國度",
  ...
  "guide.howToPlay.deathBody": "若你倒下，可在最近的墓地釋放靈魂，再跑回自己的屍體。不會損失任何經驗值。",
  ...
  "guide.howToPlay.onlineBody": "與所有人一同遊玩共享的線上伺服器，或在瀏覽器中開啟即時的離線世界來熟悉操作。",
  ...
  "guide.combat.hitBody": "攻擊可能會失手，或被閃躲、招架與格擋，敵人的攻擊也是如此。與和你等級相近的對手作戰並保持裝備更新，正是讓你的攻擊命中的關鍵。",
  "guide.combat.mitigationTitle": "護甲與裝備讓你屹立不搖",
  "guide.combat.mitigationBody": "護甲能減緩物理傷害，合適的裝備能削弱魔法傷害，因此升級裝備是你續戰力的主要來源。重甲職業能承受更多傷害，但沒有任何東西能讓你刀槍不入。",
  ...
  "guide.glossary.dpsDef": "每秒傷害，用以粗略衡量某事物造成傷害的速度。",
  ...
  "guide.faqPage.a5": "九種，涵蓋經典的坦克、治療與輸出角色定位，每種都有自己的資源與招牌技能。",
  ...
  "guide.family.spider.desc": "在黑暗糾結之地築巢的織網者與毒蟲。",
  "guide.family.murloc.name": "魚人",
  "guide.family.murloc.desc": "兩棲的沼澤居民，成群聚集於淺灘，喧鬧且強烈護衛地盤。",
  "guide.family.kobold.name": "狗頭人",
  "guide.family.kobold.desc": "頭頂蠟燭的挖掘者，盤踞於礦坑與洞穴中，凶猛地守衛著礦石。",
  "guide.family.humanoid.name": "類人生物",
  "guide.family.humanoid.desc": "盜匪、邪教徒，以及其他誤入歧途之人。他們靠戰術作戰，而非只憑蠻力。",
  "guide.family.troll.name": "巨魔",
  "guide.family.troll.desc": "體型龐大、癒合迅速的蠻獸，棲居於沼澤與高地之中。",
  ...
  "guide.worldPage.marshBlurb": "一片被霧氣與廢墟淹沒的國度。魚人成群湧入淺灘，更古老之物在水下蠢動，沼橋鎮的人們從橋上警戒注視著。",
  ...
  "guide.questsPage.objectivesBody": "擊殺特定敵人、收集物品，或與世界中的某物互動。畫面上的任務追蹤器會隨著你的進展計算進度。",
  "guide.questsPage.turninTitle": "繳交任務",
  "guide.questsPage.turninBody": "返回任務發布者處（地圖會指示位置），即可獲得經驗值、金幣，以及通常會有一件配合你職業挑選的裝備。",
  "guide.questsPage.partyTitle": "組隊接任務",
  "guide.questsPage.partyBody": "附近的隊伍成員會共享擊殺與目標進度，所以一起接任務只會更快，絕不會更慢。",
  ...
  "guide.questsPage.soloNote": "主線劇情完全可以單人完成；只有最終幾個章節需要組隊。",
  ...
  "guide.abilityHook.divine_protection": "快速的神聖護盾，在情勢危急時吸收傷害。",
  ...
  "guide.abilityHook.seal_of_righteousness": "為你的攻擊附加神聖傷害，再以審判將其消耗。",
  ...
  "guide.abilityHook.summon_imp": "召喚一隻小鬼，從遠處朝敵人投擲火焰箭。",
  ...
  "guide.arenaPage.coliseumBody": "競技場是這個王國的鬥技舞台，你會在排名對戰中面對其他玩家。獲勝便能提升排名，最強的鬥士會登上排行榜供眾人見證。",
  ...
  "guide.petHook.doomguard": "一隻精英施法者，從遠處降下沉重的暗影傷害。",
  "guide.petHook.felguard": "一隻耐打的近戰猛將，是你能召喚後的全能型寵物。",
  "guide.petHook.felhunter": "一隻暗影游擊手，專門糾纏敵方施法者。",
  "guide.petHook.imp": "一隻遠程的火焰箭惡魔，從安全距離外慢慢削弱敵人。",
  "guide.petHook.infernal": "一隻龐大的巨獸，擁有摧枯拉朽的近戰，為純粹的力量而召喚。",
  "guide.petHook.succubus": "一隻快速的近戰惡魔，攻擊兇猛但承受壓力時容易倒下。",
  "guide.petHook.voidwalker": "一隻堅實的惡魔，會嘲諷並吸收攻擊，讓你能安心施法。",
  "guide.related": "相關內容",
  ...
  "guide.talentsPage.resetNote": "你隨時都能重置天賦，所以早期的選擇絕不會是陷阱。儘管嘗試，看看自己喜歡什麼，並自由地改變主意。",
  ...
  "guide.wishPage.i2Body": "當你倒下時，會在墓地以靈魂出竅復活，再跑回自己的屍體。不會損失任何經驗，所以放心去冒險、去學習。",
  ...
  "guide.arenaPage.powerupsBody": "戰鬥進行到一半，發光的能量球也會落入競技場，誰先搶到就歸誰。它們刻意設計得誇張過火，且只持續短短一陣子：速度惡魔讓你瞬間飆出令人目眩的步伐，巨像讓你脹大成笨重的巨人，月靴帶來低重力的彈跳躍動，狂戰士則是一股突如其來的暴怒之潮。",
  ...
  "guide.bestiary.flavor.brightwood_stag": "一頭高傲的林地雄鹿，會低下牠那頂鹿角王冠橫衝直撞，而且被逼得愈久就愈難對付。",
  ...
  "guide.bestiary.flavor.mirejaw_frenzy": "一隻沼澤魚人，會在戰鬥中把自己鞭策成一陣亂揮亂打的狂亂，是一群喧鬧又護地的同類中嗓門最大的那個。",
  ...
  "guide.combat.ccBody": "控場是一種特殊的減益，會限制目標所能做的事：暈眩、定身與緩速、阻斷施法的沉默、繳械、恐懼，還有能讓敵人短暫無害的變形術。其中有些，例如定身、恐懼與變形術，若太快重複施加便會失去效用，因此無法永無止盡地連鎖控制。",
  "guide.combat.deathBody": "若你的生命值歸零，你便倒下了。稍候片刻你會復活，並從中斷之處繼續，所以死亡只會花掉你一點時間，而非進度。戰鬥之間請坐下進食飲水，好讓你以全盛狀態迎接下一場。",
  "guide.combat.deathTitle": "當你倒下時",
  "guide.combat.effectsBody": "許多技能會施加一個會持續存在的效果。有益的（增益）能提升你的屬性、為你護盾，或一點一滴地治療你；有害的（減益）則以持續傷害消耗你的生命，或使你衰弱。留意動作列附近的小圖示，便能看出你身上有哪些效果以及還剩多久。",
  "guide.combat.effectsTitle": "增益、減益與控場",
  "guide.dungeonsPage.cryptLeadBody": "在群峰高處，遠離主要戰場之外，藏著一樁更為冰冷的謎團。古老的墳墓刻著一頂無任何記載記得的王冠，而守護它們的亡者曾侍奉一位被遺忘的國王。讀懂他們的墓碑，蒐集他們守存的拱心石，你便能解封一座有三位忠魂以死封閉的陵墓，為循線追查到底的人開啟第二場十人試煉。",
  "guide.dungeonsPage.cryptLeadTitle": "一道亡者本應永遠緊閉的門",
  "guide.dungeonsPage.templeLoreBody": "這座神殿有著自己的傳說，比你在別處追查的邪教更為古老。在微光湖的岸邊（那是一座飲下月光、又交還溺亡者的山中湖泊），一名孤獨的看守者守著一道蒼白光芒之門。在水面之下，一道冰冷的石階向下通往那裡。沉沒在此的人並非死於意外：他們是蒼白唱詩班，在禮拜中沉入水底，自此再未停止吟唱。古老的守衛在被湖水吞沒之前，在岩石上刻下了唯一一句警語，一段向他們稱之為溺月之物獻上的禱詞，其下另有一隻更沉穩的手添上了兩個字：它只是沉睡。",
  ...
  "guide.economy.intro": "錢幣是整個世界的潤滑劑：它能購買裝備與補給、支付你的修理與任務開銷，並在玩家之間流轉。這一切只要遊玩就能自然累積，所以不妨把這一頁當成一張地圖，看看你的錢從何處來、又往何處去。",
  "guide.economy.junkBody": "你用不上的掉落物仍能賣給任何商人，因此每當你經過城鎮時就清空背包，別讓它們塞滿。真正一文不值的零碎雜物也可以直接丟棄以騰出空間。",
  "guide.economy.junkTitle": "清理雜物",
  "guide.economy.marketBody": "商人經營著世界市場，那是一個由玩家驅動的交易所，讓你能與或許從未謀面的人買賣。與商人對話即可開啟它。",
  ...
  "guide.economy.vendorsBody": "城鎮與哨站裡到處是商人，各有各的生意。補給商備有食物與飲品，武器匠與盔甲匠出售裝備，草藥師經營施法材料，軍需官則準備實用的旅行用品。走到他們面前，便能看到他們在賣什麼。",
  ...
  "guide.gear.cosmeticsSkins": "有兩條外觀路線可供收集。每種職業都有少數幾款替代外觀，那是專屬於它的全新風貌，唯你能穿戴。在它們之外還有染色：具名的雙色配色方案，能徹底為一款外觀重新上色，從沉穩的金屬色到鮮明的帝國色調皆有。",
  "guide.gear.cosmeticsTitle": "外觀與裝飾",
  "guide.gear.fishingBody": "釣魚是一種沉靜的調劑。裝備一根釣竿，向開闊的水域拋竿，再把上鉤之物拉上來。你大多會釣到能烹調成食物的魚、偶爾賣得幾枚銅板的雜物，以及時不時出現的珍貴稀有漁獲。你能釣到什麼，取決於你下竿的水域。",
  "guide.gear.fishingFood": "你拉上來的魚是生的，而生魚就是食物。把漁獲烹調過後，當你坐下進食時便能回復更多，而較好的魚來自北方更冷、更深的水域。在湖邊下一根線，是在戰鬥之間悄悄補充背包存糧的方法。",
  ...
  "guide.gear.slotsBody": "你有一個武器欄位與七個護甲欄位。你裝備的每一件都會強化你的角色，而隨著你找到升級品，便能自由搭配組合。",
  ...
  "guide.lore.elwynBody": "北谷一片陽光普照的林間空地唯一的守護者。她的職責是看管，而非殺戮：剔除過度繁衍之物，並讓林地中最年邁的野獸得到比死於狼口更仁慈的結局。",
  ...
  "guide.progression.prestigeBody": "經驗值在抵達上限之後仍會持續計算。它會灌注一個純外觀的虛擬等級，讓你的經驗條繼續攀升，還有一個你能為了榮耀而掙得的長期聲望階級。它純屬選擇性質，絕不賦予力量，只是你所走過的旅途的一個印記。",
  "guide.progression.restedBody": "當你登出，或在旅店這類安全之處休息時，你的角色會在你離開期間累積充分休息經驗。下一次你出門戰鬥，那一池經驗便會額外加成你的擊殺，直到耗盡為止。它會隨時間累積，加速你的早期等級，所以在城鎮裡登出絕非浪費時間。",
  ...
  "guide.questsPage.sagaMarshBody": "在泥沼，溺斃絕非意外。有人正像在填滿一個奉獻箱般填滿這片沼澤，從每一個被湖水吞沒的旅人身上喚起聽命的亡者。沿著命令的鏈條一路追查到溺沒堡壘中的喚霧者，他的遺言道出了某種更為古老之物，正在群峰之下蠢動。",
  "guide.questsPage.sagaMarshTitle": "沼澤：一筆靈魂的貢品",
  "guide.questsPage.sagaPeaksBody": "在棘峰，整場圖謀變得清晰。自谷地以來竊取的每一個靈魂，都是傾注於喚醒一個封印在山下的遠古之物的貢品。始於一座禮拜堂庭院的線索，終結於此，一道需要十人才能開啟的門前。至於門後等候的是誰，就留給你自己去揭曉了。",
  ...
  "guide.questsPage.sideCryptBody": "在群峰高處流傳著一樁更為靜謐的謎團：古老的墳墓上刻著一頂無任何記載記得的王冠。讀懂亡者，蒐集他們所守護之物，解封一座本應永遠緊閉的陵墓。這是一條偵探般的線索，為一支完整的團隊開啟了通往第二場終局試煉的道路。",
  "guide.questsPage.sideCryptTitle": "被遺忘的國王",
  "guide.questsPage.sideTitle": "主線之外的支線",
  "guide.questsPage.sideWardenBody": "在故事之外，谷地與沼澤的守衛還會發布一道長期的懸賞階梯。一個敵人接一個敵人地往上爬，就像在你之前的每一位守衛掙得席位的方式那樣。這是踏實的升級，也是一趟巡覽各區域最惡劣麻煩製造者的旅程。",
  ...
  "guide.questsPage.typeGroupBody": "主線故事的每一個篇章都終結於一道地城之門。前導部分可單人完成，但對一個篇章反派的最後一擊，是為五人隊伍而設（而最末一場，則是十人）。",
  ...
  "guide.questsPage.typeMusterBody": "安全地護送一張友善的面孔從一處抵達另一處，或在北征之前召集一座城鎮的守衛。這些任務讓你與那些你身在其故事之中的人們一同前行。",
  "guide.questsPage.typeMusterTitle": "護送與召集",
  ...
  "guide.social.chanGeneralBody": "一個常駐的本地頻道，供你周遭的人使用，適合用來提問或閒聊。",
  ...
  "guide.social.partyBody": "對另一名玩家的名字按右鍵並選擇邀請，或用聊天指令來邀請他。一支隊伍最多容納五名玩家，你們其中一人為隊長。",
  ...
  "guide.stats.intBody": "智力能擴大施法者的法力池，並提升他們的法術打出暴擊的機率。它對那些以法力施法的職業很重要；對怒氣或能量職業而言則作用甚微。",
  ...
  "guide.stats.sheetBody": "在遊戲中開啟角色視窗，便能在同一處看到這一切：你的五項屬性在一側，它們所灌注的各項數值在另一側。將滑鼠停在任一數值上，提示框便會拆解它為你的職業做了什麼，讓你一眼就能看出一件升級品實際上改動了哪些數字。",
  ...
  "guide.worldPage.gladeBody": "並非谷地裡的每一個故事都與亡者有關。在北方，一片名為碧木林地、陽光普照的林間空地保有它自己更為平和的節奏，由一名寧願看管它而非戰鬥的孤獨遊俠守望著。她的職責是平衡：剔除過度繁衍之物，並在林地老去的鹿王巢穴變得太過危險而不能放任不管時，給予牠一個體面的結局。這是你正在追隨的軌跡的一段柔和對照，值得你繞道一訪。",
  ...
  "guide.worldPage.marshPlaceNotes": "沼橋鎮鎮守著唯一一條乾燥的道路。潛獵蘆葦叢與深沼淺灘擠滿了沼澤野獸與魚人；寡婦密林被蛛網織得密不透風；溺亡禮拜堂與巨魔土塚藏著更古老的危險；喚墓者營地是邪教的據點，而沉沒堡壘則是沼澤的副本核心。",
  "guide.worldPage.peaksGreeter": "瑟莎莉隊長，高守哨站",
  "guide.worldPage.peaksGreeting": "這座城牆已守了兩百年。它不會在我當值時破，但它正在呻吟。",
  "guide.worldPage.peaksPlaceNotes": "高守哨站鎮守著城牆。潛行者山脊與深岩地洞屬於山脊巨貓與狗頭人；食人魔山麓與卓格瑪戰營屬於受僱的暴徒；風暴岩劈啪作響地竄動著元素，微光湖則在其下發著光；龍裔邪教帳篷與亡魂之野環繞著邪教佔據的高地，墓龍聖所就矗立於其頂峰。",
