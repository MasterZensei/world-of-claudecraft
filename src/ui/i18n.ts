...
export const gameStrings = {
  ...
  arena: {
    ...
    offlineNote: "The Ashen Coliseum is a ranked arena for the live world. Play online to enter the queue and climb the ladder.",
    bracket1v1: "1v1",
    bracket2v2: "2v2",
    ranked1v1: "1v1 Ranked",
    ranked2v2: "2v2 Ranked",
    enterQueue: "Enter the Queue",
    leaveQueue: "Leave Queue",
    queueNote1v1: "You will be matched with the nearest-rated challenger online, then teleported to the sands. Win to climb; first to yield (1 health) loses. You return exactly where you queued.",
    queueNote2v2: "Invite a partner to your party, then queue together as a premade team. Solo queue pairs you with a random teammate at match time. Win when the enemy team is defeated; each player yields at 1 health.",
    premadeHint: "Queue with your party (party leader only).",
    partyInviteHint: "Invite someone to your party to queue as a premade 2v2 team. Right-click a player or use the party menu.",
    partyRoster: "Your Team",
    partyLeader: "Leader",
    partyMember: "Member",
    queueAsTeam: "Queue as Team",
    waitingForLeader: "Waiting for your party leader to queue…",
    partyTooBig: "2v2 premade requires a party of exactly two — leave extra members first.",
    alreadyQueuedOther: "You are already in the {bracket} queue. Leave it before switching brackets.",
    searchingBracket: "Searching for opponents ({bracket})… {n} in queue",
    matchInProgress: "Match in progress vs {opp}.",
    ladderOnline: "Ladder — Online",
    ladderAllTime: "Ladder — All-Time",
    noChallengers: "No challengers ranked yet — be the first.",
    ratingWl: "Rating · {wins} wins / {losses} losses",
    vs: "VS",
    teamVs: "{allies} vs {enemies}",
    alliesLabel: "Allies",
    foesLabel: "Foes",
    you: "You",
    steelYourself: "Steel yourself…",
    returning: "Returning to the world… {n}",
    fight: "Fight to the yield!",
    queued: "Queued for the Ashen Coliseum ({bracket}, position {pos}).",
    unqueued: "You leave the Ashen Coliseum queue.",
    opponentFound: "Opponent found: {name}",
    opponentsFound: "Opponents found: {names}",
    pairedAgainst: "The Coliseum pairs you against {name}, level {level} {cls}.",
    pairedAgainstTeam: "The Coliseum pairs you against {names}.",
    fightBanner: "Fight!",
    countdown: "The bout begins in {n}…",
    drawVs: "Arena draw vs {opp} ({delta} rating)",
    drawLog: "Arena bout vs {opp} ended in a draw. Rating {rating} ({delta}).",
    victoryVs: "Victory vs {opp}!  Rating {rating} ({delta})",
    victoryLog: "You defeated {opp} in the Ashen Coliseum. Rating {rating} ({delta}).",
    defeatVs: "Defeated by {opp}.  Rating {rating} ({delta})",
    defeatLog: "{opp} bested you in the Ashen Coliseum. Rating {rating} ({delta}).",
  },
};
