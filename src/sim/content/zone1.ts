...
export const ZONE1_MOBS: Record<string, MobTemplate> = {
  ...
  sableweb_matriarch: {
    ...
    summonAdds: { mobId: 'sableweb_hatchling', count: 2, atHpPct: [0.6, 0.3] },
    loot: [
      { copper: 130, chance: 1 },
