...
export const DELVE_ITEMS: Record<string, ItemDef> = {
  ...
  reliquary_plate_chest: {
    id: 'reliquary_plate_chest', name: 'Reliquary Guard Hauberk', kind: 'armor', slot: 'chest',
    quality: 'uncommon', stats: { armor: 90, sta: 2, str: 1 }, sellValue: 240, requiredClass: WAR,
  },
  reliquary_leather_chest: {
    id: 'reliquary_leather_chest', name: 'Dustwarden Jerkin', kind: 'armor', slot: 'chest',
    quality: 'uncommon', stats: { armor: 55, agi: 2, sta: 1 }, sellValue: 215, requiredClass: ROG,
  },
  reliquary_cloth_chest: {
    id: 'reliquary_cloth_chest', name: 'Shroud of the Reliquary', kind: 'armor', slot: 'chest',
    quality: 'uncommon', stats: { armor: 30, int: 2, spi: 1 }, sellValue: 205, requiredClass: MAG,
  },
  reliquary_legs: {
    id: 'reliquary_legs', name: 'Vaultbound Legwraps', kind: 'armor', slot: 'legs',
    quality: 'uncommon', stats: { armor: 48, sta: 2 }, sellValue: 195,
  },
  reliquary_helm: {
    id: 'reliquary_helm', name: 'Ossuary Watch Helm', kind: 'armor', slot: 'helmet',
    quality: 'uncommon', stats: { armor: 48, sta: 2, str: 1 }, sellValue: 220, requiredClass: WAR,
  },
  reliquary_shoulder: {
    id: 'reliquary_shoulder', name: 'Crumbled Spaulders', kind: 'armor', slot: 'shoulder',
    quality: 'uncommon', stats: { armor: 36, sta: 2 }, sellValue: 175,
  },
  ...
  varric_shadow_cowl: {
    id: 'varric_shadow_cowl', name: "Varric's Shadow Cowl", kind: 'armor', slot: 'helmet',
    quality: 'rare', stats: { armor: 42, int: 4, spi: 3 }, sellValue: 540, requiredClass: MAG,
  },
};
